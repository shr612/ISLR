# intutive explantion for maximum likelihood estimation using AIC and BIC
...
# Some  conclusion 
### All three methods correctly identified the 3rd degree polynomial as the best model.
### So it works. Interestingly, all three methods penalize lack of fit much more heavily than redundant 
### complexity. I knew this about AIC, which is notoriously known for insufficient penalization of overly 
### complex models. BIC should penalize complexity more than AIC does (Hastie et al. 2009), which is 
###  what Fig. 2 shows clearly. But still, the difference is not that pronounced. I was surprised to 
###  see that crossvalidation is also quite benevolent in terms of complexity penalization – perhaps 
###  this is really because crossvalidation and AIC are equivalent (although the curves in Fig. 2 do 
###  not seem identical).
